...
import {setCurrentTime, setUseFakeTime, setWizardComplete} from "../../store/enviornment/enviornment.actions";
    ...
    return (
        <IonPage>
            ...
            <IonContent fullscreen>
                ...
                <IonItem>
                    <a onClick={() => store.dispatch(setWizardComplete(false))}>Einrichten starten</a>
                </IonItem>
                <IonItem>
                    <a onClick={() => store.dispatch(setShowTip(true))}>Trinkgeld geben</a>
                </IonItem>
